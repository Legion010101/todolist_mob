...
const MainRouting = () => {
  return (
      ...
      >
        ...
        />
        <Stack.Screen
          name="CompletedTodos" component={CompletedTodos} options={{title: "Выполненые дела"}}
        />
        <Stack.Screen
          name="CreateTodo" component={CreateTodo} options={{title: "Добавить дело"}}
        />
        <Stack.Screen
          name="DeleteTodos" component={DeleteTodos} options={{title: "Корзина"}}
        />
        <Stack.Screen
